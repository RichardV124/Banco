...
@Named("creditCardPaymentController")
@ViewScoped
public class CreditCardPaymentController implements Serializable{
	...
	public void pagarCuota(){
		System.out.println("asdkasdlkdaslkd" +cuentaSeleccionada);
			try {
				creditCardPaymentEJB.crearCreditCardPaymentCuentaAhorros(numerotarjeta, excedente,cuentaSeleccionada);
