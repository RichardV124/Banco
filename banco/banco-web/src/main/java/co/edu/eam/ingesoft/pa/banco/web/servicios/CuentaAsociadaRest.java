...
public class CuentaAsociadaRest {
	...
	public boolean transferir(String asociadaSeleccionada,String cuentaSeleccionada,double monto) throws Exception{

		savAccountEJB.tranferenciaInterbancaria(asociadaSeleccionada, cuentaSeleccionada, monto);
		return true;
	}
}
